...
@Component({
    ...
    <form class="talk" (ngSubmit)="onSubmit()" #talkForm="ngForm">
        ...
        <div class="form-group">
            ...
            <input type="text" id="avatarUrl" [(ngModel)]="talk.speaker.avatar" ngControl="avatarUrl" #avatarUrl="ngForm" required>
            <div [hidden]="avatarUrl.valid || avatarUrl.pristine" class="talkEdit-errorMessage">
